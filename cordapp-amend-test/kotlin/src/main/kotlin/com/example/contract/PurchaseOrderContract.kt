...
open class PurchaseOrderContract() : Contract {
    ...
    companion object {
        val logger = loggerFor<PurchaseOrderContract>()
    }
    /**
    ...
    interface Commands : CommandData {
        ...
        //data class Amend(override val nonce: Long = random63BitValue()): IssueCommand, Commands
        // Can be this way?... Same result
    ...
    interface Clauses {
        ...
        class Group : GroupClauseVerifier<PurchaseOrderState, Commands, UniqueIdentifier>(AnyComposition(Place(), Amend())) {
        ...
        class Amend : Clause<PurchaseOrderState, Commands, UniqueIdentifier>() {
            ...
            override fun verify(tx: TransactionForContract,
                ...
                // @roger, this verification is being invoked twice on amendments...
                // is it normal, or is there some bug in the code???

                logger.info("Amend clause invoked!")
